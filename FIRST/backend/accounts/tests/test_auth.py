...
class AuthTests(TestCase):
    ...
    def test_response_allowlist_and_no_store_and_disabled_social(self):
        response = self.register()
        self.assertEqual(set(response.json()['user']), {'id', 'email', 'username', 'full_name', 'birth_date', 'gender', 'phone', 'email_verified', 'phone_verified', 'profile_complete', 'providers', 'capabilities'})
