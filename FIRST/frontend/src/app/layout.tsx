...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="tr"><body><a className="skip" href="#main">İçeriğe geç</a><header><Link href="/hesap">FIRST</Link><nav aria-label="Ana gezinme"><Link href="/giris">Giriş</Link><Link href="/kayit">Kayıt</Link><Link href="/hesap">Hesabım</Link></nav></header><main id="main">{children}</main></body></html>;}
