...
Implement'te mevcut pattern ve ürün kurallarını uygulat. Review'da dosya değiştirmeden P0/P1/P2 ve kanıt iste. Verify'da kaynak kodu/diff incelemesi ile acceptance eşleşmesini iste. Kullanıcı açıkça istemedikçe test veya computer use görevi verme; çalıştırılmamış davranışı doğrulanmış sayma. Revizyonda önceki bulguyu ve beklenen düzeltmeyi belirt; ilgisiz refactor ekleme.
